...
class TestRoomBridgeGlobalVars:
    ...
    def test_flush_global_vars_calls_apply_when_pending(self) -> None:
        ...
        mock_store.get.return_value = {"k": "v"}
        rest_bridge.global_store = mock_store
        try:
...
class TestGlobalVariablesEndpoint:
    ...
    def test_post_too_many_global_vars_returns_409(self, client: TestClient) -> None:
        """Filling the store then adding one more should yield 409."""
        from styly_netsync import rest_bridge
