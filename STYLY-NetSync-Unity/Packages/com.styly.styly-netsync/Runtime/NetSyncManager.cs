...
namespace Styly.NetSync
{
    ...
    public class NetSyncManager : MonoBehaviour
    {
        ...
        private void InitializeManagers()
        {
            ...
            _heartbeatManager = new HeartbeatManager(_connectionManager, _deviceId);
        ...
        private void OnServerDiscovered(string serverAddress, int dealerPort, int transformPort, int statePort)
        {
            _discoveredServer = serverAddress;
            _discoveredDealerPort = dealerPort;
            _discoveredTransformSubPort = transformPort;
            _discoveredStateSubPort = statePort;
            ...
            _transformSubPort = transformPort;
            _stateSubPort = statePort;

            DebugLog($"Server discovered: {serverAddress} (dealer:{dealerPort}, transform:{transformPort}, state:{statePort})");
        }
        #endregion ------------------------------------------------------------------------
